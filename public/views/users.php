            ...
            <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                                ...
                                <span class="status status-<?= !empty($user["status_name"]) ? $user["status_name"] : 'danger';?> mr-3">
                                    <span class="rounded-circle profile-image d-block" style="background-image:url('<?= !empty($user['image']) ? $user['image'] : 'views/img/demo/avatars/avatar-m.png'; ?>'); background-size: cover;"></span>
                                </span>
                        <div class="info-card-text flex-1">
                            <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                <?=$user['username']?>
                                <?php if($userRole || QueryBuilder::is_equal($user,$userId)):?>
